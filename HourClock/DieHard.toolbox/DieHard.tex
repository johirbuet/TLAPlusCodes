...
\@x{ SmallToBig \.{\defeq}}%
 \@x{ \.{\LET} poured\@s{2.20} \.{\defeq} Min ( big \.{+} small ,\, 5 ) \.{-}
 big}%
\@x{ \.{\IN} \.{\land} big \.{'} \.{=} big \.{+} poured}%
\@x{\@s{20.39} \.{\land} small \.{'} \.{=} small \.{-} poured}%
\@pvspace{8.0pt}%
\@x{ BigToSmall \.{\defeq}}%
 \@x{ \.{\LET} poured\@s{2.35} \.{\defeq} Min ( big \.{+} small ,\, 3 ) \.{-}
 small}%
\@x{ \.{\IN} \.{\land} big \.{'} \.{=} big \.{-} poured}%
\@x{ \.{\land}\@s{9.28} small \.{'} \.{=} small \.{+} poured}%
\@pvspace{16.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 06 11:30:30 \ensuremath{CST} 2016 by \ensuremath{johir
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Dec} 06
 10:41:51 \ensuremath{CST} 2016 by \ensuremath{johir
}%
\end{cpar}%
\end{lcom}%
\end{document}
